from . import Abstract_Huffman
from tqdm import tqdm
import heapq
import os

class Huffman_original(Abstract_Huffman):
    def __init__(self, path, read_bit_size=8):
        super(Huffman_original, self).__init__(path, read_bit_size)
    ...
    def make_frequency_dict(self, text):
        ...
        if self.read_bit_size == 8:
            ...
            for i in tqdm(range(0,len(text)-4, 4)):
                char = text[i:i+4]
